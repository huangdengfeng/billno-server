...
public final class BillnoGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.seezoon.stub.billno.GetBillnoReq,
      com.seezoon.stub.billno.GetBillnoResp> getGetBillnoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetBillno",
      requestType = com.seezoon.stub.billno.GetBillnoReq.class,
      responseType = com.seezoon.stub.billno.GetBillnoResp.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.seezoon.stub.billno.GetBillnoReq,
      com.seezoon.stub.billno.GetBillnoResp> getGetBillnoMethod() {
    io.grpc.MethodDescriptor<com.seezoon.stub.billno.GetBillnoReq, com.seezoon.stub.billno.GetBillnoResp> getGetBillnoMethod;
      ...
      synchronized (BillnoGrpc.class) {
        if ((getGetBillnoMethod = BillnoGrpc.getGetBillnoMethod) == null) {
          BillnoGrpc.getGetBillnoMethod = getGetBillnoMethod =
              io.grpc.MethodDescriptor.<com.seezoon.stub.billno.GetBillnoReq, com.seezoon.stub.billno.GetBillnoResp>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetBillno"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.seezoon.stub.billno.GetBillnoReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.seezoon.stub.billno.GetBillnoResp.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getBillno(com.seezoon.stub.billno.GetBillnoReq request,
        io.grpc.stub.StreamObserver<com.seezoon.stub.billno.GetBillnoResp> responseObserver) {
  ...
  public static final class BillnoStub
     ...
     * </pre>
     */
    public void getBillno(com.seezoon.stub.billno.GetBillnoReq request,
        io.grpc.stub.StreamObserver<com.seezoon.stub.billno.GetBillnoResp> responseObserver) {
  ...
  public static final class BillnoBlockingStub
     ...
     * </pre>
     */
    public com.seezoon.stub.billno.GetBillnoResp getBillno(com.seezoon.stub.billno.GetBillnoReq request) {
  ...
  public static final class BillnoFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.seezoon.stub.billno.GetBillnoResp> getBillno(
        com.seezoon.stub.billno.GetBillnoReq request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BILLNO:
          serviceImpl.getBillno((com.seezoon.stub.billno.GetBillnoReq) request,
              (io.grpc.stub.StreamObserver<com.seezoon.stub.billno.GetBillnoResp>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.seezoon.stub.billno.GetBillnoReq,
              com.seezoon.stub.billno.GetBillnoResp>(
  ...
  private static abstract class BillnoBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.seezoon.stub.billno.BillnoOuterClass.getDescriptor();
    }
